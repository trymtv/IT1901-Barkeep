...
public class HttpManager {
     ...
     */
    public static int postJsonTo(String uri, String requestBody) throws IOException, AuthenticationException {
     ...
     * @throws AuthenticationException if the context set is not correctly configured.
     */
    static public int deleteFrom(String uri) throws IOException, AuthenticationException {
